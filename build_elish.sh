...
sed -i "s/${local_version_str}/${local_version_date_str}/g" arch/arm64/configs/elish_defconfig
...
sed -i "s/${local_version_date_str}/${local_version_str}/g" arch/arm64/configs/elish_defconfig
